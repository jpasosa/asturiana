...
<div class="col-left-tr-flechas-wrapper">
  <div class="cuadro">
    <div class="titulo">
      <?php a_slot("cl-tr-flechas-titulo", 'aRichText', array('tool' => 'Main')) ?>
    </div>
    <div id="scroll-contenido" class="contenido">
      <?php a_slot("cl-tr-flechas-contenido", 'aText', array('multiline' => true)) ?>
    </div>
  </div>
</div>
