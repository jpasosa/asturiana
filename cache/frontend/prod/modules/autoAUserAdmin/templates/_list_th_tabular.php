...
<?php include_slot('a-admin.current-header') ?>
	...
	<?php slot('a-admin.current-header') ?>
	<th class="a-admin-date a-admin-list-th-updated_at">
		  <?php if ('updated_at' == $sort[0]): ?>
	    <?php echo link_to(__('Updated at', array(), 'apostrophe'), 'aUserAdmin/index?sort=updated_at&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc')) ?>
	    <?php echo image_tag(((sfConfig::get('app_aAdmin_web_dir'))?sfConfig::get('app_aAdmin_web_dir'):'/apostrophePlugin').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'apostrophe'), 'title' => __($sort[1], array(), 'apostrophe'))) ?>
	  <?php else: ?>
	    <?php echo link_to(__('Updated at', array(), 'apostrophe'), 'aUserAdmin/index?sort=updated_at&sort_type=asc') ?>
	  <?php endif; ?>
		</th>
	<?php end_slot(); ?>
