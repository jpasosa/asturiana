	  ...
	  <form action="<?php echo url_for('a_user_admin_collection', array('action' => 'filter')) ?>" method="post" id="a-admin-filters-form">
	    ...
	    <div class="a-admin-filters-fields">
	        ...
	        <?php if ((isset($form[$name]) && $form[$name]->isHidden()) || (!isset($form[$name]) && $field->isReal())) continue ?>
	          ...
	          <?php include_partial('aUserAdmin/filters_field', array(
	            'name'       => $name,
        ...
        <?php echo $form->renderHiddenFields() ?>
				<div class="a-form-row submit">
					<ul class="a-controls a-admin-filter-controls">
						...
						<li><?php echo link_to(__('reset', array(), 'apostrophe'), 'a_user_admin_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'a-btn a-cancel')) ?></li>
					</ul>
				</div>
